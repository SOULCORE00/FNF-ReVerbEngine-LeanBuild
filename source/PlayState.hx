...
class PlayState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		var the:Float = (healthBar.percent * 0.01) + 0.01;

		//the bounce oh magawd cjmdiosjcdioscjids
		iconP1.setGraphicSize(Std.int(iconP1.width + (50 * the)),Std.int(iconP2.height - (25 * the)));
		iconP2.setGraphicSize(Std.int(iconP2.width + (50 * (2 - the))),Std.int(iconP2.height - (25 * (2 - the))));
